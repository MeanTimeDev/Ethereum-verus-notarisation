...
contract BLAKE2b is BLAKE2_Constants {
    ...
    function blake2b_256(bytes memory input,bytes memory personalization) public view returns (bytes32) {
        uint64[4] memory result = blake2b(input, "", "", personalization, 32);
        return sum256(result);
    }
